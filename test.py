...
r = requests.post(url + '/login', json={"username":"Mikolov", "password":"4zr5HE"}, verify=False)
#print(r.json())
...
# DELETE
# supprimer des données
params = {'article_id': 'b9512669-8144-43ed-81d8-a192f92c4cd3'}
headers = { 'x-access-tokens' : token }
...
# ajouter des données
contrib = {
    "article_id": "b9512669-8144-43ed-81d8-a192f92c4cd3",
    "contrib_data": "mlem-_sound_2-2019-09-03T193015.084Z-.wav",
    "contrib_name": "m\u025b\u0301le\u0304m",
    "contrib_path": "https://ntealan.net/soundcontrib/",
    "contrib_type": "sound",
...
params = {'article_id': 'b9512669-8144-43ed-81d8-a192f92c4cd3'}
headers = { 'x-access-tokens' : token }
r = requests.post(url + '/data', headers=headers, json=contrib, params=params, verify=False )
print(r.json())
assert r.json() == {'OK': 'Données modifées avec succès'}
